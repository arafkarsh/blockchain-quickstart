...
public final class AssetTransfer implements ContractInterface {
    ...
    public String TransferAsset(final Context ctx, final String assetID, final String newOwner) {
        ...
        /**
         * Conditions > To validate transactions by checking lot of parameters
         * Like Start Date, End Date, Amount, Currency
         * Get Score
         */
        Asset asset = genson.deserialize(assetJSON, Asset.class);
        ...
        String newStateJSON = genson.serialize(newAsset);
        stub.putStringState(assetID, newStateJSON);
